...
class AuthController {
  registerCustomer(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const customer = yield (0, customer_service_1.findCustomer)(
          username,
          email
        );
        ...
        const token = (0, jsonwebtoken_1.sign)(payload, process.env.JWT_KEY, {
          expiresIn: "10m",
        });
  ...
  loginCustomer(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const isValidPass = yield (0, bcrypt_1.compare)(
          password,
          customer.password
        );
        if (!isValidPass) {
        ...
        const cus = Object.assign(Object.assign({}, customer), {
          role: "customer",
        });
        res
          .status(200)
  ...
  verifyCustomer(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const verifiedCustomer = (0, jsonwebtoken_1.verify)(
          token,
          process.env.JWT_KEY
        );
  ...
  registerOrganizer(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        if (password != confirmPassword)
          throw { message: "Password not match!" };
        const organizer = yield (0, organizer_service_1.findOrganizer)(
          name,
          email
        );
  ...
  loginOrganizer(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        const Orga = Object.assign(Object.assign({}, organizer), {
          role: "organizer",
        });
        res
          .status(200)
  ...
  verifyOrganizer(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        const { token } = req.params;
        const verifiedOrganizer = (0, jsonwebtoken_1.verify)(
          token,
          process.env.JWT_KEY
        );
